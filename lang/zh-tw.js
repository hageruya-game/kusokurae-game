...
// === 反應 ===
reactions: {
  waitCorrect: ["總算", "勉強及格", "看出來了嘛"],
  correct: ["……", "哼", "還不夠", "然後呢？", "嘖"],
  timeout: "時間到",
  waitMiss: ["別碰", "太淺了", "看不出來嗎？"],
  schoolMiss: ["怕突出？", "有人在看你", "被氣氛吞了", "又融入了", "又跟風了"],
  miss: ["看不出來？", "太慢", "天真", "痛吧？"],
  gameoverTaunts: ["就這樣？", "不值得評分", "等級？給你？", "可悲", "滾吧"],
  slashGOClose: ["……好可惜", "就差一點", "下次能到嗎？", "本來想認可你的"],
  slashGOMid: ["……無聊", "失去興趣了", "算了", "已經忘了"],
  slashGOEarly: ["就這樣？", "令人失望", "出去", "別再來了", "弱到笑不出來"],
},
