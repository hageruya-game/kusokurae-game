...
// === インタールード（ステージ間キモキャラ台詞） ===
interlude: {
  s1toS2Lines: ["まだ終わったと思うな", "ここからが本番だ", "少しは楽しませろ", "調子に乗るなよ"],
  s1GoodLines: ["……読めてきたな", "気に食わないが、悪くない", "その顔、少し腹が立つな"],
  s1MidLines: ["調子に乗るなよ", "まだ先は長いぞ", "少しは読めてきたか"],
  s1BadLines: ["…やるじゃないか", "ギリギリだったな", "見苦しいが、生き残ったか"],
},

// === 最終クリア キモキャラリアクション ===
clearReact: {
  goodLines: ["……なんだそれは", "ありえない", "想定外だ"],
  midLines: ["……やるじゃないか", "気に入らない", "まだ あまいがな"],
  badLines: ["……生き残ったか", "運が良かったな", "見苦しいがな"],
},
...
// === リアクション ===
reactions: {
  waitCorrect: ["やっとか", "それでいい", "少しは読めたな"],
  correct: ["……", "ほう", "まだだ", "それで？", "チッ"],
  timeout: "時間切れ",
  waitMiss: ["触るな", "浅い", "見えてないのか"],
  schoolMiss: ["浮くのが怖いか", "見られてるぞ", "空気に負けたな", "それで埋もれる", "また合わせたか"],
  miss: ["読めなかったか", "遅い", "甘いな", "効いたろ"],
  gameoverTaunts: ["この程度で終わりか", "評価する価値もない", "ランク？ お前に？", "話にならんな", "もう帰れ"],
  slashGOClose: ["……惜しかったな", "あと少しだったのに", "次は届くか？", "認めてやりたかった"],
  slashGOMid: ["……つまらん", "興味を失った", "もういい", "覚えてもいない"],
  slashGOEarly: ["その程度か", "期待外れだ", "帰れ", "もう来るな", "弱すぎて笑えない"],
},
